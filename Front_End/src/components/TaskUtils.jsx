...
//                             <button
//                                 type="button"
//                                 className="bg-gray-300 text-black rounded-lg px-6 py-3 text-base w-full sm:w-auto flex justify-center items-center space-x-2 transition duration-200 hover:bg-gray-400"
//                                 onClick={onClose}
//                             >
...
//                             <button
//                                 type="submit"
//                                 className={`bg-blue-600 text-white rounded-lg px-6 py-3 text-base w-full sm:w-auto flex justify-center items-center space-x-2 transition duration-200 hover:bg-blue-700 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""
//                                     }`}
//                                 disabled={isSubmitting}
//                             >
//                                 <span className="hidden sm:inline">{isSubmitting ? "Submitting..." : "Save"}</span>
